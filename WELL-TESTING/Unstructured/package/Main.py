...
Simulation_name = '01Simulation_wellIndex'
        ...
        for char_len in char_len_list:
            for val in paramList:
                ...
                if problem_type=='lineSource':
                    ...
                    output_dir_mesh='DFNs/' + str(DFN_name) + '/Meshes/'+DFN_textName +'/Processsed'+str(char_len)
                    ...
                    with pd.ExcelWriter(f'{outputDir}/{Simulation_name}.xlsx', engine='openpyxl') as writer:
                        ...
                        for ith_step in range(num_report_steps):
                            ...
                            fileName = DFN_textName + str(char_len)
                            ...
                            frameName = DFN_textName+str(char_len) + str(ith_step)
                        ...
                        v.makeGif(input_name=DFN_textName+str(char_len), num_report_steps=num_report_steps, output_file=SimName +DFN_textName+ '.gif', duration=2)
